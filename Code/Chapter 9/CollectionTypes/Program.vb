' This example illustrates working with non-generic collection
' types in the System.Collections namespace. 
' Uncomment / comment out function calls to test.

Module Program

  Sub Main()
    Console.WriteLine("***** Fun with non-generic collections *****")
    ' ArrayListTest()
    ' QueueTest()
    StackTest()
    Console.ReadLine()
...
#Region "ArrayList test"
  Sub ArrayListTest()
    ...
    Dim carArList As ArrayList = New ArrayList
