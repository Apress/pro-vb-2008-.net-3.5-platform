<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="BuildCar.aspx.vb" Inherits="Default2" title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Label ID="Label1" runat="server" Font-Size="X-Large" Text="Use this Wizard to build your Dream Car"
        Width="254px"></asp:Label><br />
    <br />
    <asp:Wizard ID="carWizard" runat="server" ActiveStepIndex="0" BackColor="#E6E2D8"
        BorderColor="#999999" BorderWidth="1px" Font-Names="Verdana" Font-Size="0.8em"
        ...
        <StartNavigationTemplate>
            <asp:Button ID="StartNextButton" runat="server" BackColor="White" BorderColor="#C5BBAF"
    ...
    <br />
    <asp:Label ID="lblOrder" runat="server" Font-Size="X-Large"></asp:Label><br />
</asp:Content>
